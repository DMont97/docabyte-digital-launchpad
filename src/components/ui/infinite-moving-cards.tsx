      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-2 mb-4">
            <Handshake className="w-6 h-6 text-cyan-600" strokeWidth={2.5} />
            <span className="font-semibold text-sm uppercase tracking-widest text-cyan-600">
              Testimonios de nuestros clientes
            </span>
          </div>
          <h2 className="font-extrabold text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight">
