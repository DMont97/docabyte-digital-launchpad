...
const Hero = () => {
  return (
    <section id="inicio" className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50/50 to-cyan-50/30 flex flex-col items-center justify-start px-4 sm:px-6 lg:px-8 pt-24 relative overflow-hidden">
      {/* Spline 3D Model as Background - z-0 */}
      ...
      {/* Div transparente para manejar scroll - z-1 */}
      <div className="absolute inset-0 z-1 w-full h-full bg-transparent" />

      {/* Content overlay - z-2 */}
      <div className="max-w-4xl mx-auto text-center space-y-12 relative z-2 mt-8 sm:mt-12">
        {/* Title and Subtitle */}
