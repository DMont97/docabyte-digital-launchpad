      ...
      <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-500 ${
        ...
        <div className="flex items-center justify-between h-full">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className={`bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-full font-medium shadow-md hover:shadow-lg hover:shadow-orange-500/25 hover:scale-105 transition-all duration-300 hover:from-orange-600 hover:to-red-600 ${
